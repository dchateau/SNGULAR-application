    ...
    <Container isColumnArranged justifyContent="center">
      ...
      <Container>
        <Container isColumnArranged>
          <p className="text-xl text-blue-500">
            The <span className="italic">{getNthTermLabel(nthTerm)}</span> term
            of Fibonacci's series is:
          </p>
          <p className="text-4xl text-blue-500 font-bold">{resultFibonacci}</p>
        </Container>
        <Container isColumnArranged>
        ...
        <Container isColumnArranged>
          <p className="text-xl text-rose-400">
            The <span className="italic">{getNthTermLabel(nthTerm)}</span> prime
            number is:
          </p>
      ...
      <p className="text-xl text-gray-800">
        ...
        <span className="font-bold">
          {2 * resultFibonacci + 3 * resultTriangular - 7 * resultPrimeNumber}
        </span>
      </p>
    </Container>
  );
